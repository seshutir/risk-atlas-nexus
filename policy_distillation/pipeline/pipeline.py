...
from policy_distillation.explanation.bipartite_graph import BipartiteGraph
from policy_distillation.models.explainers.global_explainers.global_expl import (
    GlobalExplainer,
)
...
class Pipeline:
    ...
    def run(self, dataset: AbstractDataset, path="results/") -> GlobalExplainer:
        ...
        print(local_expl_path, global_expl_path)
